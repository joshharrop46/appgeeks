...
$spp_settings->url_rewrites = array( 
    'show' => array('separator' => '-', 'rule' => 'opt/(.*)', 'index' => 1, 'permalink' => 'opt/{{ term }}/' ), //0
