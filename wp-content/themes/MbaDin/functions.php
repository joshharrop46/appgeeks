...
<div class="box"><div id="serasi">Related Post</div><?php include (TEMPLATEPATH . '/related.php'); ?></div>
<?php }
if ( function_exists('register_sidebar_widget') )
register_sidebar_widget(__('Virtarich Related'), 'widget_related');
?>
<?php
define( 'HEADER_IMAGE', '%s/images/headered.jpg' ); 
